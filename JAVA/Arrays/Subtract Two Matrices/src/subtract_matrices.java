 ...
 * 		Subtracts them up and displays the new Matrix to the User.
 * 
 * ############################################################################
 * ############################################################################
*/
...
public class subtract_matrices {
	public static void main(String[] args) {
		...
		for ( int i = 0 ; i < row ; i++ ) {
			for  ( int j = 0 ; j < col ; j++ ) {
				diff[i][j] = first[i][j] - second[i][j];			// Save the difference of the first and the second matrix in sum
			}
		}
		...
		for ( int i = 0 ; i < row ; i++ ) {
			for  ( int j = 0 ; j < col ; j++ ) {
				System.out.print(diff[i][j] + "\t");			// Display the new matrix
			}
